...
class UnCLIPPipeline(DiffusionPipeline):
    ...
    def __call__(
        ...
        decoder_text_mask = F.pad(text_mask.cpu(), (self.text_proj.clip_extra_context_tokens, 0), value=1).to(text_mask.device)
        ...
        image_upscaled = F.interpolate(
            image_small.float(), size=[height, width], mode="bicubic", align_corners=False, **interpolate_antialias
